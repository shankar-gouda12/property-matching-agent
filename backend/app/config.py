...
class Settings:
    ...
    INVENTORY_HEADER_ROW = int(
        os.getenv("INVENTORY_HEADER_ROW", "2")
    )

    INVENTORY_REFRESH_SECONDS = int(
        os.getenv("INVENTORY_REFRESH_SECONDS", "30")
    )
    ...
    AUTH_TOKEN_EXPIRE_MINUTES = int(
        os.getenv("AUTH_TOKEN_EXPIRE_MINUTES", "480")
    )
